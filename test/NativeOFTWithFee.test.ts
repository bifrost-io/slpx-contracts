...
describe("NativeOFTWithFee: ", function () {
    ...
    it("sendFrom() - tokens from main to other chain using default", async function () {
        ...
        const aliceAddressBytes32 = ethers.utils.defaultAbiCoder.encode(["address"], [receiver.address])
        // estimate nativeFees
        nativeFee = (await nativeOFTWithFee.estimateSendAndCallFee(localChainId, aliceAddressBytes32, totalAmount, "0x00", 700000, false, ethers.utils.solidityPack(["uint16", "uint256"], [1, 1500000])))
            .nativeFee
        ...
        await remoteOFTWithFee.sendAndCall(
            ...
            "0x00",
            700000,
            [owner.address, ethers.constants.AddressZero, ethers.utils.solidityPack(["uint16", "uint256"], [1, 1000000])],
