...
//    }
//
//    function mintVNativeAsset(address receiver, bytes memory remark) external payable override whenNotPaused {
...
//    }
//
//    function mintVAsset(address, uint256, address, bytes memory) external pure override {
//        require(false, "Not support");
//    }
//
//    function stablePoolSwap(uint32 poolId,
//        uint32 poolTokenIndexIn,
//        uint32 poolTokenIndexOut,
//        uint256 amount,
//        uint128 minDy,
//        address receiver) external pure override {
//        require(false, "Not support");
//    }
//
