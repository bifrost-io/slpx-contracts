...
//   waitFor,
//   mintVtoken,
//   bifrostTransferTokenToAstar,
//   AstarTransferAstrToBifrost,
// } from "./utils";
//
// const main = async () => {
...
//     parachain_api.tx.balances.forceTransfer(
//       alice.address,
//       TEST_ACCOUNT,
//       1000n * ASTR_DECIMALS
//     ),
...
//     ),
//     // set bnc metadata
//     parachain_api.tx.assets.forceSetMetadata(
//       18446744073709551623n,
//       "Bifrost Native Coin",
//       "BNC",
//       12,
...
//
//   await bifrostTransferTokenToAstar(bifrost_api, alice, BNC, 1000n * BNC_DECIMALS);
//   await AstarTransferAstrToBifrost(parachain_api, alice, 1000n * ASTR_DECIMALS);
...
//   };
//
//   await democracyForCallNeedRootOrigin(
//     bifrost_api,
//     alice,
//     bifrost_api.tx.zenlinkProtocol.createPair(bnc, vastr)
//   );
//   await democracyForCallNeedRootOrigin(
//     bifrost_api,
//     alice,
//     bifrost_api.tx.zenlinkProtocol.createPair(bnc, astr)
//   );
//   await addLiquidity(
//     bifrost_api,
//     alice,
